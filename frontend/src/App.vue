    ...
    <main class="main">
      ...
      <div class="content">
        ...
        <div v-if="activeTable === 'teachers'">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title" style="margin-bottom:0">Teaching Staff</h3>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr v-if="teachers.length === 0">
                    <td colspan="2" class="empty">No teachers found</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr v-if="subjects.length === 0">
                    <td colspan="2" class="empty">No subjects found</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div v-if="activeTable === 'attendance'">
          <div class="card">
            ...
            <div class="table-wrap">
              <table>
                <thead><tr><th>#ID</th><th>Student ID</th><th>Date</th><th>Status</th></tr></thead>
                <tbody>
